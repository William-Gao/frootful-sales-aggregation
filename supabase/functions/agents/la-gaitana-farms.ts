/**
 * La Gaitana Farms — org-specific agent definition.
 *
 * Uses base tools only. Customize the prompt below as we learn
 * their catalog, variant conventions, and ordering patterns.
 */
...
const ORG_ID = '81cf0716-45ee-4fe8-895f-d9af962f5fab';
...
function buildSystemPrompt(customers: Customer[], items: Item[]): string {
  ...
  return `You are Frootful's order processing agent for La Gaitana Farms.
